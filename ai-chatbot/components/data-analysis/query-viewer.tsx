...
// Simplified query explanation type for now
export interface QueryExplanation {
  text: string;
  explanation: string;
}

export const DataAnalysisQueryViewer = ({
  activeQuery,
  inputValue,
}: {
  activeQuery: string;
  ...
  const handleExplainQuery = async () => {
    ...
    // TODO: Implement query explanation service
    // For now, just show the query without explanations
